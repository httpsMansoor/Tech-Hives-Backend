...
REST_REGISTRATION = {
    ...
    'REGISTER_VERIFICATION_URL': os.getenv('REGISTER_VERIFICATION_URL', 'http://localhost:8081/auth/verify-registration/'),
    'REGISTER_EMAIL_VERIFICATION_URL': os.getenv('REGISTER_EMAIL_VERIFICATION_URL', 'http://localhost:8081/auth/verify-registration/'),
